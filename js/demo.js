...
document.getElementById("template").onchange = function () {
    ...
    if (TEMPLATE_QUERIES[selected].variables.indexOf('timepoint') > -1) {
        $("#timepoint").removeClass('hidden');
    }
    if (TEMPLATE_QUERIES[selected].variables.indexOf('protein') > -1) {
